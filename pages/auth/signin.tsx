...
export default function LoginPage() {
  const handleSignIn = (e: Event) => {
    e.preventDefault();
    signIn("github", { callbackUrl: "https://github-rest-user.netlify.app/api/auth/callback/github", scope: "read:user" });
  }
  return (
    <div id={styles.main}>
        <div id={styles.logos}>
        ...
        <div id={styles.textContainer}>
            ...
            <button id={styles.signinBtn} onClick={() => handleSignIn}>Sign in with GitHub</button>
        </div>
    </div>
  );
}
